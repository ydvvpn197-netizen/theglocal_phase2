            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    If we agree the moderation was incorrect, we'll restore your content or account
                    and update our moderation log.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    If the original decision stands, we'll explain why and provide clarity on the
                    guidelines.
                  </p>
                </div>
              </div>
