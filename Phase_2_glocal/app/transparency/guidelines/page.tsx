          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Respect everyone's right to privacy. Never share personal information about others
                without consent. Use anonymous handles to protect identities.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Keep discussions focused on your local community. Share content that's relevant to
