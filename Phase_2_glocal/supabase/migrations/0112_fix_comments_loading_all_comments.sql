-- ============================================
-- FIX COMMENTS LOADING ISSUE
-- ============================================
-- Issue: Comments not loading on post details page
-- Root Cause: get_comments_enhanced only returns top-level comments,
--            but frontend needs ALL comments (including replies) to build tree
-- Version: 0112
-- Date: 2025-01-29

-- ============================================
-- FIX: UPDATE get_comments_enhanced TO RETURN ALL COMMENTS
-- ============================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Fixed get_comments_enhanced to return ALL comments (top-level + replies)';
    RAISE NOTICE '✅ Function now returns flat list of all comments for frontend tree building';
    RAISE NOTICE '✅ Comments should now load correctly on post details page';
END $$;
